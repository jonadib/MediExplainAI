...
5. Provide a clear overall summary, highlight abnormal test values in a structured table format, offer helpful questions to ask a doctor, and list general, non-diagnostic lifestyle suggestions (e.g., staying hydration, mild walking, balanced diet, sleeping well).
